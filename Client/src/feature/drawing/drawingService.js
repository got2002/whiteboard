...
export const drawingService = {
  ...
  emitReorderStroke: (pageId, strokeId, newIndex) => socket.emit("reorder-stroke", { pageId, strokeId, newIndex }),
  emitRedo: (pageId, stroke) => socket.emit("redo", { pageId, stroke }),
  emitClearPage: (pageId, options) => socket.emit("clear-page", { pageId, ...options }),
  ...
  onReorderStroke: (cb) => socket.on("reorder-stroke", cb),
  ...
  offReorderStroke: (cb) => socket.off("reorder-stroke", cb),
