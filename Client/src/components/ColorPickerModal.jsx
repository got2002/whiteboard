      ...
      <div className="cp-modal-content" onMouseDown={e => e.stopPropagation()}>
        ...
        <div className="cp-body">
          ...
          <div className="cp-palettes">
            ...
            <div className="cp-section">
              <div className="cp-label">Custom colors</div>
              <div className="cp-grid custom">
                {customColors.map((c, i) => (
                  <div 
                    key={`custom-${i}`} 
                    className={`cp-color-box custom-box ${selectedColor === c && c !== "#ffffff" ? 'active' : ''}`}
                    style={{ backgroundColor: c }}
                    onClick={() => handleColorBoxClick(c)}
                  />
                ))}
            ...
            <button className="cp-btn add-custom-btn" onClick={handleAddToCustomColors}>
              Add to custom colors
            </button>
          </div>

          {/* ส่วนขวา: สีและการปรับแต่ง Picker */}
          <div className="cp-interactive">
            <div className="cp-pickers">
              ...
              >
                <div 
                  ...
                  style={{
                    background: `linear-gradient(to bottom, #fff, ${rgbToHex(hslToRgb(hsv.h, hsv.s, 0.5)[0], hslToRgb(hsv.h, hsv.s, 0.5)[1], hslToRgb(hsv.h, hsv.s, 0.5)[2])}, #000)`
                  }}
                />
                <div 
            ...
            <div className="cp-inputs">
              <div className="cp-preview-box">
                <div className="cp-preview-color" style={{ backgroundColor: selectedColor }} />
              </div>
